...
import com.example.yogi.yomusic.adapter.SlidingQueueAdapter;
...
import com.example.yogi.yomusic.util.YomusicUtils;
import com.example.yogi.yomusic.widgets.PlayPauseButton;
...
public class NowPlayingFragment_1 extends Fragment {
    ...
    public Runnable mUpdateProgress = new Runnable() {
        ...
        public void run() {
            ...
            if(mProgressBar!=null)
            {
                ...
                {
                    mSongElapsedTime.setText(YomusicUtils.makeShortTimeString(getContext(),currentPosition/1000));
                }
            }
    ...
    private void updateSongDetails() {
        ...
        {
            mSongDuration.setText(YomusicUtils.makeShortTimeString(getContext(),mediaPlayerService.getCurrentTrack().getDurInt()/1000));
        }
        else if (mediaPlayerService.getCurrentTrack()==null)
        {
            mSongDuration.setText(YomusicUtils.makeShortTimeString(getContext(),0));
        }
    ...
    private class SetBlurredAlbumArt extends AsyncTask<Bitmap, Void, Drawable>
    {
        ...
        protected Drawable doInBackground(Bitmap... bitmaps) {
            ...
            try
            {
                drawable = YomusicUtils.createBlurredImageFromBitmap(bitmaps[0],getContext(),12);
            }
            catch (Exception e)
            {
                e.printStackTrace();
